      ...
      fetch("http://127.0.0.1:8086/api/users/authenticate", requestOptions)
          .then(response => {
            if (response.ok) {
                ...
                window.location.href = "https://github.com/beijanm/"
              } else {
  ...
  <form action="javascript:login_user()">
    ...
    <p>
     <button class="button-spacing">Log In</button>
          <button onClick = "window.location.href ='http://127.0.0.1:4200/beijan.web//2024/01/31/Signup.html'" class="button-spacing" >Sign Up</button>
